...
def main():
    ...
    parser.add_argument('--aria2', nargs='?', const="-x10", default=None, help='download with aria2. You can also specify optional arguments (default: "-x10". please sure to quote). `-o` is already automatically included.')
